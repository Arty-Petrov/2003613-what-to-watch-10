//Пока не понятно что это за элемент и зачем он нужен,
// но он почти одинаково повторяется на всех страницах проекта,
// поэтому решил вынести его в отдельный компонент

type SomeProps = {
  addElement: boolean;
}

function SomeComp({addElement}: SomeProps): JSX.Element {
  return (
...
function SomeOptionElement(): JSX.Element {
  return (
